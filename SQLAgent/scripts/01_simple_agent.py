...
Key Components:
- ChatGoogleGenerativeAI: The language model that powers the agent
...
# ChatGoogleGenerativeAI: Creates an Google Gemini model instance for the agent
# Parameters:
#   - model: Specifies which Gemini model to use (gpt-4o-mini is cost-effective)
...
#   - agent_type: Specifies the agent architecture ("tool-calling" uses function calling)
