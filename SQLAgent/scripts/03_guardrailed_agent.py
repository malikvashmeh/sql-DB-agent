...
# ChatGoogleGenerativeAI: Creates connection to OpenAI's GPT models
# Parameters:
...
#   - agent: Agent type using tool calling for tool selection
...
agent = initialize_agent(
    ...
    agent=AgentType.TOOL_CALLING,  # Use function calling for precise tool selection
